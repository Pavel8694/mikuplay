...
async def show_user_menu(edit_function):
    ...
    # logger.info(f"🏠 Пользователь @{callback_query.from_user.username} ({callback_query.from_user.id}) вернулся в главное меню для юзеров.")
